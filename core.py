...
def process_image(input_path, save_output=False, output_folder="output_hsv"):
    ...
    if not contours:
        return {
            "success": False,
            "message": "Kontur tubuh depan tidak ditemukan."
        }
    ...
    if not contours_final:
        return {
            "success": False,
            "message": "Kontur final depan tidak ditemukan."
        }
    ...
    if not contours_final_crop:
        return {
            "success": False,
            "message": "Kontur final depan setelah auto-crop tidak ditemukan."
        }
    ...
    if len(xs) == 0 or len(ys) == 0:
        return {
            "success": False,
            "message": "Mask tubuh depan kosong."
        }
...
def process_image_side(input_path, save_output=False, output_folder="output_side"):
    ...
    if len(xs) == 0 or len(ys) == 0:
        return {
            "success": False,
            "message": "Mask tubuh samping kosong."
        }
